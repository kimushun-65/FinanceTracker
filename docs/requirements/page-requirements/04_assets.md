...
- **口座削除**: 
  - 削除確認ダイアログ
  - 「この口座を削除しますか？」警告表示
  - 削除実行（DELETE /accounts/{accountId}使用）
- **手動更新**: 残高の手動入力・更新
...
|                |  +--------------------------------------------------------------------+          |
|                |  | Asset Name         | Type        | Balance     | % | Change | Actions  |          |
|                |  |-------------------|-------------|-------------|---|--------|----------|          |
...
|                |  +--------------------------------------------------------------------+          |
|                |                                                                                 |
|                |  Asset Forecast (1 Year)                                                          |
|                |  +--------------------------------------------------------------------+          |
|                |  | Current Total Assets:     ¥1,500,000                               |          |
|                |  | Predicted in 1 Year:      ¥1,680,000                               |          |
|                |  | Expected Growth:          +12.0% (+¥180,000)                       |          |
|                |  |                                                                    |          |
|                |  | [🔮 Calculate 1-Year Forecast]                                     |          |
|                |  +--------------------------------------------------------------------+          |
|                |                                                                                 |
+----------------+---------------------------------------------------------------------------------+
```
